...
Thanks for using the EVC Team Relay MCP server. This page is the whole map: where to go, and what happens after you write.

## Where to go

| What you have | Where to put it | First response |
|---|---|---|
| A bug | [Open an issue](https://github.com/entire-vc/evc-team-relay-mcp/issues/new/choose) | 2 business days |
...
This repository holds the MCP server that exposes Team Relay to agent tooling. Some things live
elsewhere:
